...
public class Tablero extends javax.swing.JPanel {
 ...
 public void Graficar(Graphics g1){
   ...
   Graphics2D g = (Graphics2D)g1; 
    z = (form.RetEstir()*0.5+10);
    xi= this.getWidth()/2-8;
    yi= this.getHeight()/2-5;
    ...
    // Hexagono 0
    int x0[] = {xi,xi,xi+(int)(Math.cos(Math.PI/6)*z),xi+(int)(z*Math.cos(Math.PI/6)*2),xi+(int)(z*Math.cos(Math.PI/6)*2),xi+(int)(Math.cos(Math.PI/6)*z)};
    ...
    // Hexagono 1
    int x1[] ={(int)(bx[5]-Math.cos(Math.PI/6)*(z+z0)),(int)(bx[5]-Math.cos(Math.PI/6)*(z+z0)),bx[5],(int)(bx[5]+Math.cos(Math.PI/6)*(z+z0)),bx[0],bx[5]};
    ...
    // Hexagono 2
    int x2[] ={(int)(bx[5]-Math.cos(Math.PI/6)*(z+z0)*2),(int)(bx[5]-Math.cos(Math.PI/6)*(z+z0)*2),tx15,bx[5],bx[4],(int)(bx[5]-Math.cos(Math.PI/6)*(z+z0))};
    ...
    // Hexagono 3
    int x3[] ={(int)(bx[4]-Math.cos(Math.PI/6)*(z+z0)),tx12,bx[4],bx[3],(int)(bx[4]+Math.cos(Math.PI/6)*(z+z0)),x0[1]};
    ...
    // Hexagono 4
    int x4[] ={tx9,bx[3],bx[2],(int)(x0[2]+Math.cos(Math.PI/6)*(z+z0)*2),(int)(x0[2]+Math.cos(Math.PI/6)*(z+z0)*2),(int)(x0[2]+Math.cos(Math.PI/6)*(z+z0))};
    ...
    // Hexagono 5
    int x5[] ={bx[2],bx[1],(int)(bx[2]+Math.cos(Math.PI/6)*(z+z0)),(int)(bx[2]+Math.cos(Math.PI/6)*(z+z0)*2),(int)(bx[2]+Math.cos(Math.PI/6)*(z+z0)*2),tx6};
    ...
    // Hexagono 6
    int x6[] ={bx[0],tx0,x0[4],(int)(bx[1]+Math.cos(Math.PI/6)*(z+z0)),tx3,bx[1]};
    ...
    // Hexagono 7
    int x7[] ={(int)(tx14-Math.cos(Math.PI/6)*(z+z0+z1)),(int)(tx14-Math.cos(Math.PI/6)*(z+z0+z1)),tx14,tx16,tx15,tx14};
    ...
    // Hexagono 8
    int x8[] ={(int)(ax25-Math.cos(Math.PI/6)*(z+z0+z1)),(int)(ax25-Math.cos(Math.PI/6)*(z+z0+z1)),ax25,tx14,tx13,ax25};
    ...
    // Hexagono 9
    int x9[] ={(int)(tx13-Math.cos(Math.PI/6)*(z+z0+z1)),ax22,tx13,tx12,tx11,tx13};
    ...
    // Hexagono 10
    int x10[] ={(int)(tx11-Math.cos(Math.PI/6)*(z+z0+z1)),ax20,tx11,tx10,(int)(tx11+Math.cos(Math.PI/6)*(z+z0+z1)),tx11};
    ...
    // Hexagono 11
    int x11[] ={ax17,tx10,tx9,tx8,(int)(tx10+Math.cos(Math.PI/6)*2*(z+z0+z1)),(int)(tx10+Math.cos(Math.PI/6)*(z+z0+z1))};
    ...
    // Hexagono 12
    int x12[] ={ax15,tx8,tx7,(int)(tx8+Math.cos(Math.PI/6)*2*(z+z0+z1)),(int)(tx8+Math.cos(Math.PI/6)*2*(z+z0+z1)),(int)(tx8+Math.cos(Math.PI/6)*(z+z0+z1))};
    ...
    // Hexagono 13
    int x13[] ={tx7,tx6,tx5,(int)(tx7+Math.cos(Math.PI/6)*2*(z+z0+z1)),(int)(tx7+Math.cos(Math.PI/6)*(z+z0+z1)*2),ax12};
    ...
    // Hexagono 14
    int x14[] ={tx5,tx4,(int)(tx4+Math.cos(Math.PI/6)*(z+z0+z1)),(int)(tx4+Math.cos(Math.PI/6)*2*(z+z0+z1)),(int)(tx4+Math.cos(Math.PI/6)*2*(z+z0+z1)),ax10};
    ...
    // Hexagono 15
    int x15[] ={tx3,tx2,x14[1],(int)(x14[1]+Math.cos(Math.PI/6)*(z+z0+z1)),ax7,tx4};
    ...
    // Hexagono 16
    int x16[] ={tx1,tx1,(int)(tx1+Math.cos(Math.PI/6)*(z+z0+z1)),(int)(tx1+2*(z+z0+z1)*Math.cos(Math.PI/6)),ax5,tx2};
    ...
    // Hexagono 17
    int x17[] ={tx17,(int)(ax2-Math.cos(Math.PI/6)*(z+z0+z1)*2),(int)(ax2-Math.cos(Math.PI/6)*(z+z0+z1)),ax2,tx1,tx0};
    ...
    // Hexagono 18
    int x18[] ={ax27,(int)(ax0-Math.cos(Math.PI/6)*(z+z0+z1)*2),(int)(ax0-Math.cos(Math.PI/6)*(z+z0+z1)),ax0,tx17,tx16};
    ...
    // Hexagono 19
    int x19[] ={(int)(ax24-Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax24-Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax24,ax26,ax25,ax24};
    ...
    // Hexagono 20
    int x20[] ={(int)(ax24-2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax24-2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx32,ax24,ax23,(int)(ax24-Math.cos(Math.PI/6)*(z+z0+z1+z2))};
    ...
    // Hexagono 21
    int x21[] ={(int)(ax23-Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx29,ax23,ax22,ax21,ax23};
    ...
    // Hexagono 22
    int x22[] ={(int)(ax21-Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx27,ax21,ax20,ax19,ax21};
    ...
    // Hexagono 23
    int x23[] ={(int)(ax19-Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx25,ax19,ax18,(int)(ax19+Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax19};
    ...
    // Hexagono 24
    int x24[] ={lx22,ax18,ax17,ax16,(int)(ax17+Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax17};
    ...
    // Hexagono 25
    int x25[] ={lx20,ax16,ax15,ax14,(int)(ax15+Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax15};
    ...
    // Hexagono 26
    int x26[] ={lx18,ax14,ax13,(int)(ax13+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax13+Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax13};
    ...
    // Hexagono 27
    int x27[] ={ax13,ax12,ax11,(int)(ax11+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax11+Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx15};
    ...
    // Hexagono 28
    int x28[] ={ax11,ax10,ax9,(int)(ax9+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax9+Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx13};
    ...
    // Hexagono 29
    int x29[] ={ax9,ax8,(int)(ax8+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax8+2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax8+2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx11};
    ...
    // Hexagono 30
    int x30[] ={ax7,ax6,(int)(ax6+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax6+2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx8,ax8};
    ...
    // Hexagono 31
    int x31[] ={ax5,ax4,(int)(ax4+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax4+2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx6,ax6};
    ...
    // Hexagono 32
    int x32[] ={ax3,ax3,(int)(ax3+Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax3+2*Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx4,ax4};
    ...
    // Hexagono 33
    int x33[] ={ax1,ax1,(int)(ax1+Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx1,ax3,ax2};
    ...
    // Hexagono 34
    int x34[] ={ax29,ax29,(int)(ax29+Math.cos(Math.PI/6)*(z+z0+z1+z2)),lx41,ax1,ax0};
    ...
    // Hexagono 35
    int x35[] ={(int)(ax28-Math.cos(Math.PI/6)*(z+z0+z1+z2)),(int)(ax28-Math.cos(Math.PI/6)*(z+z0+z1+z2)),ax28,lx39,ax29,ax28};
    ...
    // Hexagono 37
    int x37[] ={(int)(lx31-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx31-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx31,lx33,lx32,lx31};
    ...
    // Hexagono 38
    int x38[] ={(int)(px42-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(px42-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px42,lx31,lx30,px42};
    ...
    // Hexagono 39
    int x39[] ={(int)(lx30-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px39,lx30,lx29,lx28,lx30};
    ...
    // Hexagono 40
    int x40[] ={(int)(lx28-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px37,lx28,lx27,lx26,lx28};
    ...
    // Hexagono 41
    int x41[] ={(int)(lx26-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px35,lx26,lx25,lx24,lx26};
    ...
    // Hexagono 42
    int x42[] ={(int)(lx24-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px33,lx24,lx23,(int)(lx24+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx24};
    ...
    // Hexagono 43
    int x43[] ={px30,lx23,lx22,lx21,(int)(lx22+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx22};
    ...
    // Hexagono 44
    int x44[] ={px28,lx21,lx20,lx19,(int)(lx20+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx20};
    ...
    // Hexagono 45
    int x45[] ={px26,lx19,lx18,lx17,(int)(lx18+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx18};
    ...
    // Hexagono 46
    int x46[] ={px24,lx17,lx16,(int)(lx16+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx16+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx16};
    ...
    // Hexagono 47
    int x47[] ={lx16,lx15,lx14,(int)(lx14+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx14+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px21};
    ...
    // Hexagono 48
    int x48[] ={lx14,lx13,lx12,(int)(lx12+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx12+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px19};
    ...
    // Hexagono 49
    int x49[] ={lx12,lx11,lx10,(int)(lx10+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx10+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px17};
    ...
    // Hexagono 50
    int x50[] ={lx10,lx9,(int)(lx9+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx9+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx9+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px15};
    ...
    // Hexagono 51
    int x51[] ={lx8,lx7,(int)(lx7+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx7+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px12,lx9};
    ...
    // Hexagono 52
    int x52[] ={lx6,lx5,(int)(lx5+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx5+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px10,lx7};
    ...
    // Hexagono 53
    int x53[] ={lx4,lx3,(int)(lx3+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx3+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px8,lx5};
    ...
    // Hexagono 54
    int x54[] ={lx2,lx2,(int)(lx2+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx2+2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px6,lx3};
    ...
    // Hexagono 55
    int x55[] ={lx0,lx0,(int)(lx0+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px3,lx2,lx1};
    ...
    // Hexagono 56
    int x56[] ={lx40,lx40,(int)(lx40+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px1,lx0,lx41};
    ...
    // Hexagono 57
    int x57[] ={lx38,lx38,(int)(lx38+Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px53,lx40,lx39};
    ...
    // Hexagono 58
    int x58[] ={(int)(lx37-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx37-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),lx37,px51,lx38,lx37};
    ...
    // Hexagono 59
    int x59[] ={(int)(lx35-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),(int)(lx35-Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px48,lx37,lx36,lx35};
    ...
    // Hexagono 61
    int x61[] ={px42-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px42-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px42-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px43,px42,px41};
    ...
    // Hexagono 62
    int x62[] ={px40-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px40-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx52,px41,px40,px40-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4))};
    ...
    // Hexagono 63
    int x63[] ={px38-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx49,px40,px39,px38,px38-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4))};
    ...
    // Hexagono 64
    int x64[] ={px36-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx47,px38,px37,px36,px36-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4))};
    ...
    // Hexagono 65
    int x65[] ={px34-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx45,px36,px35,px34,px34-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4))};
    ...
    // Hexagono 66
    int x66[] ={px32-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx43,px34,px33,px32,px32-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4))};
    ...
    // Hexagono 67
    int x67[] ={px32-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px32-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px32,px31,px31,px32};
    ...
    // Hexagono 72
    int x72[] ={rx30,px23,px22,px22+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px22+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px22};
    ...
    // Hexagono 73
    int x73[] ={px22,px21,px20,px20+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px20+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx27};
    ...
    // Hexagono 74
    int x74[] ={px20,px19,px18,px20+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px20+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx25};
    ...
    // Hexagono 75
    int x75[] ={px18,px17,px16,px18+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px18+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx23};
    ...
    // Hexagono 76
    int x76[] ={px16,px15,px14,px16+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px16+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx21};
    ...
    // Hexagono 77
    int x77[] ={px14,px13,px14+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px14+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3)),px14+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx19};
    ...
    // Hexagono 78
    int x78[] ={px12,px11,px12+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px12+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx16,px13};
    ...
    // Hexagono 79
    int x79[] ={px10,px9,px10+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px10+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx14,px11};
    ...
    // Hexagono 80
    int x80[] ={px8,px7,px8+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px8+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx12,px9};
    ...
    // Hexagono 81
    int x81[] ={px6,px5,px6+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px6+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx10,px7};
    ...
    // Hexagono 82
    int x82[] ={px4,px4,px4+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px4+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx8,px5};
    ...
    // Hexagono 83
    int x83[] ={px2,px2,px2+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx5,px4,px3};
    ...
    // Hexagono 84
    int x84[] ={px0,px0,px0+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx3,px2,px1};
    ...
    // Hexagono 85
    int x85[] ={px52,px52,px52+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx1,px0,px53};
    ...
    // Hexagono 86
    int x86[] ={px50,px50,px50+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx65,px52,px51};
    ...
    // Hexagono 87
    int x87[] ={px50-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px50-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px50-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx63,px50,px49};
    ...
    // Hexagono 88
    int x88[] ={px48-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px48-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx60,px49,px48,px47};
    ...
    // Hexagono 89
    int x89[] ={px46-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),px46-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx58,px47,px46,px45};
    ...
    // Hexagono 90
    int x90[] ={rx54,px44-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4)),rx56,px45,px44,px43};
    ...
    // Hexagono 91
    int x91[] ={rx54-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx54-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx54-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx55,rx54,rx53};
    ...
    // Hexagono 92
    int x92[] ={sx2,rx56-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx56-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx57,rx56,rx55};
    ...
    // Hexagono 93
    int x93[] ={sx4,rx58-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx58-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx59,rx58,rx57};
    ...
    // Hexagono 94
    int x94[] ={rx46-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx46-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx48,rx47,rx46,rx46-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5))};
    ...
    // Hexagono 95
    int x95[] ={rx44-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx9,rx46,rx45,rx44,rx44-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3))};
    ...
    // Hexagono 96
    int x96[] ={rx42-(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx11,rx44,rx43,rx42,rx42-(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5))};
    ...
    // Hexagono 97
    int x97[] ={rx26,rx25,rx24,rx26+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx26+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx26+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5))};
    ...
    // Hexagono 98
    int x98[] ={rx24,rx23,rx22,rx24+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx24+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx25};
    ...
    // Hexagono 99
    int x99[] ={rx22,rx21,rx20,rx22+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx22+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx23};
    ...
    // Hexagono 100
    int x100[] ={rx14,rx13,rx14+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx14+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx14+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx15};
    ...
    // Hexagono 101
    int x101[] ={rx12,rx11,rx12+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx12+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx18,rx13};
    ...
    // Hexagono 102
    int x102[] ={rx10,rx9,rx10+(int)(Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),rx10+(int)(2*Math.cos(Math.PI/6)*(z+z0+z1+z2+z3+z4+z5)),sx16,rx11};
