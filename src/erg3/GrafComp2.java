 ...
 * Autor: Cesar Peña
 */
public class GrafComp2 extends javax.swing.JPanel implements MouseListener, MouseMotionListener{
    ...
    public GrafComp2(mferg fr, double[] der, double[] izq) {
       this.form = fr;
    ...
    public void Graficar(Graphics g1,int xi,int yi){
       ...
       SV3=form.RetScaVolt3();
       ST3=form.RetScaTiem3();
      ...
      // Divisiones de Dominio y Tiempo en la Cuadrícula
       divT=(this.getWidth()/(50-ST3+1));
       divV=(this.getHeight()/(50-SV3+1));
       ...
       g.setFont(f1);
       g.drawString("S-T",this.getWidth()-25,15);
    ...
    public double[] Ret_ST_D(){
        return datxy0;
    }
    public double[] Ret_ST_I(){
        return datxy1;
    }
