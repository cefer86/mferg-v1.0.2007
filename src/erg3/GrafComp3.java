 ...
 * Autor: Cesar Peña
 */
public class GrafComp3 extends javax.swing.JPanel implements MouseListener, MouseMotionListener{
    ...
    public GrafComp3(mferg fr, double[] der, double[] izq) {
       this.form = fr;
    ...
    public void Graficar(Graphics g1,int xi,int yi){
       ...
       SV4=form.RetScaVolt4();
       ST4=form.RetScaTiem4();
       ...
       divT=(this.getWidth()/(50-ST4+1));
       divV=(this.getHeight()/(50-SV4+1));
       ...
       g.setFont(f1);
       g.drawString("I-T",this.getWidth()-25,15);
    ...
    public double[] Ret_IT_D(){
        return datxy0;
    }
    public double[] Ret_IT_I(){
        return datxy1;
    }
