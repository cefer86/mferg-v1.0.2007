...
public class GrafComp extends javax.swing.JPanel implements MouseListener, MouseMotionListener {
    ...
    public GrafComp(mferg fr, double[] der, double[] izq) {
       this.form = fr;
    ...
    public void Graficar(Graphics g1, int xi, int yi){
       ...
       SV1=form.RetScaVolt1();
       ST1=form.RetScaTiem1();
       ...
       divT=(this.getWidth()/(50-ST1+1));
       divV=(this.getHeight()/(50-SV1+1));     
       ...
       g.setFont(f1);
       g.drawString("S-N",this.getWidth()-25,15);
    ...
    public double[] Ret_SN_D(){
        return datxy0;
    } 
    public double[] Ret_SN_I(){
        return datxy1;
    }
